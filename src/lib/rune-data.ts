...
const dwRunesByTier: { [tier: number]: AvailableRune[] } = {
    ...
    3: [
        ...
        // Mágicas
        { name: "Fragmento de Substituição", rarity: "magic" },
        { name: "Fragmento da Chama Venenosa", rarity: "magic" },
        { name: "Fragmento da Ilusão", rarity: "magic" },
        { name: "Fragmento de Explosão Venenosa", rarity: "magic" },
        { name: "Fragmento da Estrela Cadente", rarity: "magic" },
        { name: "Fragmento da Perdição", rarity: "magic" },
        { name: "Fragmento de Calor", rarity: "magic" },
        { name: "Fragmento do Ceifador", rarity: "magic" },
        // Especiais
        ...
        { name: "Fragmento da Estrela Cadente", rarity: "special" },
        { name: "Fragmento da Perdição", rarity: "special" },
        { name: "Fragmento de Calor", rarity: "special" },
        { name: "Fragmento do Ceifador", rarity: "special" },
        // Comuns
        { name: "Fragmento de Runa do Escalão", rarity: "common" },
